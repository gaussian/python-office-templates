        ...
        slide_specs = [
{
                ...
                "edges": [
                    ...
                    {"from": "api_gateway", "to": "auth_service", "label": "Authenticate"},
                    {"from": "api_gateway", "to": "product_service", "label": "Query"},
        ...
        slide_specs = [
{
                ...
                "nodes": [
                    ...
                    {"id": "switch2", "name": "Switch 2", "detail": "Floor 2", "position": {"x": 6, "y": 3}},
                    {"id": "server1", "name": "Server 1", "detail": "Web Server", "position": {"x": 1, "y": 5}},
                    {"id": "server2", "name": "Server 2", "detail": "DB Server", "position": {"x": 3, "y": 5}},
                    {"id": "server3", "name": "Server 3", "detail": "App Server", "position": {"x": 5, "y": 5}},
                    {"id": "server4", "name": "Server 4", "detail": "Cache Server", "position": {"x": 7, "y": 5}},
                ],
                "edges": [
        ...
        slide_specs = [
{
                ...
                "nodes": [
                    ...
                    {"id": "n3", "name": "Node 3", "position": {"x": 1, "y": 10}},
                    {"id": "n4", "name": "Node 4", "position": {"x": 15, "y": 10}},
                ],
                "edges": [
                    {"from": "n1", "to": "n2"},
                    {"from": "n1", "to": "n3"},
        ...
        slide_specs = [
{
                ...
                "nodes": [
                    ...
                    {"id": "app", "name": "Application", "detail": "Node.js", "position": {"x": 5, "y": 3}},
                    {"id": "cache", "name": "Cache", "detail": "Redis", "position": {"x": 7, "y": 2}},
                    {"id": "db", "name": "Database", "detail": "MongoDB", "position": {"x": 7, "y": 4}},
                ],
                "edges": [
